      ...
      {open && (
        ...
        >
          ...
          >
            ...
            {/* ASU Verification hint */}
            <div className="flex items-center justify-center gap-1.5 text-xs text-gray-500 mb-1">
              <span className="w-3.5 h-3.5 relative inline-flex items-center justify-center" style={{ filter: 'drop-shadow(0 1px 1px rgba(0, 0, 0, 0.1))' }}>
                <svg viewBox="0 0 24 24" fill="#FFC627" className="w-full h-full">
                  <path d="M12 2L4 5v6.09c0 5.05 3.41 9.76 8 10.91 4.59-1.15 8-5.86 8-10.91V5l-8-3z" />
                </svg>
                <svg viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" className="w-2 h-2 absolute">
                  <polyline points="20 6 9 17 4 12" />
                </svg>
              </span>
              <span>Use <strong className="text-gray-700">@asu.edu</strong> to get verified</span>
            </div>
            <Button
              variant="outline"
