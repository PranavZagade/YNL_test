      ...
      <Dialog open={searchModalOpen} onOpenChange={setSearchModalOpen}>
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div>
              <select className="w-full px-3 py-2 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-300 focus:border-transparent"
                value={lookFor}
                onChange={(e) => setLookFor(e.target.value)}
              >
                <option value="">Look for</option>
             ...
             <div className="lg:sticky lg:top-24 space-y-4 md:space-y-6">
              {/* Host Info */}
               ...
               >
                   ...
                   <div>
                     <h3 className="text-base md:text-lg font-semibold text-gray-900">{listing.userDisplayName || 'Host'}</h3>
                   </div>
                 </div>
